    ...
    <main>
      ...
      <section className="max-w-5xl mx-auto px-4 py-16 grid gap-10 md:grid-cols-2 items-center">
        <div>
          ...
          <div className="mt-6">
            <ButtonPill href="/buildings/levy-offsets/for-committees">
      ...
      <section className="max-w-5xl mx-auto px-4 py-16 grid gap-10 md:grid-cols-2 items-center">
        ...
        <div className="md:order-2">
          ...
          <div className="mt-6">
            <ButtonPill href="/buildings/levy-offsets/for-owners">
              For Owners
            </ButtonPill>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 py-16 grid gap-10 md:grid-cols-2 items-center">
        <div>
          ...
          <div className="mt-6">
            <ButtonPill href="/buildings/levy-offsets/for-developers">
              For Developers
            </ButtonPill>
          </div>
        </div>
