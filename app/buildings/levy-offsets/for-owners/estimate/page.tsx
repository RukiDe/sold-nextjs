...
const BOOKING_URL = process.env.NEXT_PUBLIC_BOOKING_URL || ""; // optional
...
export default function OwnersEstimatePage() {
  ...
  // We’ll treat "touched" as “user has confirmed they want an estimate”
  // and set it true immediately on “Yes” so an estimate appears right away.
    ...
    <main>
      <section className="max-w-3xl mx-auto px-4 py-12">
        ...
        <p className="text-lg text-gray-700 mb-8">
          If you have a mortgage, you <span className="font-medium">may</span> be able to offset part of your apartment levy.
          Quick estimate only. No credit checks.
        </p>
          ...
          <div>
            ...
            {hasMortgage === "no" && (
              <p className="mt-4 text-sm text-gray-700">
                No worries. This particular offset is driven by an owner’s mortgage, so it won’t apply here.
              </p>
            )}
          </div>
            ...
            <div>
              ...
              {showEstimate && (
                <div className="mt-6 border border-gray-200 rounded-xl bg-gray-50 p-4 space-y-3">
                  ...
                  {/* “Why” block (tight, not preachy) */}
                  <div className="border border-gray-200 rounded-xl bg-white p-4">
                    <p className="text-sm text-gray-900 font-medium mb-1">
                      How this works (in plain English)
                    </p>
                    <p className="text-sm text-gray-700">
                      Sold offers a voluntary mortgage review. If (and only if) a better loan exists, a lender rebate{" "}
                      <span className="font-medium">may</span> be credited against your levy. If it doesn’t stack up, nothing changes.
                    </p>
                    ...
                    {sent ? (
                      <div className="space-y-3">
                        ...
                        {BOOKING_URL ? (
                          ...
                          <p className="text-xs text-gray-500">
                            (Optional) Add <span className="font-mono">NEXT_PUBLIC_BOOKING_URL</span> to show a “Book a call” button here.
                          </p>
                        )}
                      </div>
                    ) : (
                      <>
                        <p className="text-sm text-gray-700 mb-3">
                          Want the breakdown and next steps? Email it to yourself.
                        </p>
                  ...
                  <p className="text-xs text-gray-500">
                    Indicative estimate only. Offsets aren’t guaranteed and depend on lender terms and eligibility at the time of review.
                  </p>
                </div>
              )}
            </div>
