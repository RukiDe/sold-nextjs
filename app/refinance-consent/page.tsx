...
const brevoHtml = `<!-- Begin Brevo Form -->
...
<div class="sib-form" style="text-align: center;
  ...
  <div id="sib-form-container" class="sib-form-container">
    ...
    <div></div>
    <div id="sib-container" class="sib-container--large sib-container--vertical" style="text-align:center; background-color:rgba(255,255,255,1); max-width:540px; border-radius:25px; border-width:1px; border-color:#ffffff; border-style:dashed; direction:ltr">
      <form id="sib-form" method="POST" action="https://13b359ae.sibforms.com/serve/MUIFAIUlO5PrCVpUANOwmZyGyLq32IqH_Q9H6FKQ5oHuiLcTu0669rOnHcC_PZUCJ6u8c3gl0jPk7r6-Uj5TkYCPzq71KrWPu1wDjq18DGwUfNuRWiCieaAcUsLMJyztx7U9p6_c6KoSRNCoTqqpsmGI5WhxqzRdX3xYtz2SfRuRVY2N7fayXkK9TJes8ceITzRJAOxTMfRDmi7pdQ==" data-type="subscription">
          ...
          <div class="sib-input sib-form-block">
            <div class="form__entry entry_block">
              ...
              <label class="entry__specification" style="font-size:12px; text-align:left; font-family:Helvetica, sans-serif; color:#8390A4; text-align:left">
                We&#039;ll send our privacy and consent form here (check your spam folder).
              </label>
            </div>
          </div>
        </div>
        <div style="padding: 8px 0;">
          <div class="sib-form-block" style="text-align: left">
            <button class="sib-form-block__button sib-form-block__button-with-loader" style="font-size:16px; text-align:left; font-weight:700; font-family:Helvetica, sans-serif; color:#FFFFFF; background-color:#242727; border-radius:14px; border-width:0px;" form="sib-form" type="submit">
    ...
    <>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-12">
        ...
        <p className="text-lg text-neutral-700 max-w-3xl leading-relaxed">
          This is the first step in giving your home loan a health check &mdash;
          without the pressure of sitting in a branch or being sold to. We&apos;ll
          sense-check your current rate and repayments against what&apos;s
